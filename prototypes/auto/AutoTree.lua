...
ENTITY {
	...
	minable =
	{
	    ...
	    results = {
			...
			{type = "item", name = "南瓜粉", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "花椒粉", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "芝麻球", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "山药", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "灵土", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "灵壤", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "灵泉", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "灵土粉", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "灵液（瓶）", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "竹", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "种子袋", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "花椒", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "南瓜", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "灵植树", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "西瓜粉", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "西瓜", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "红薯", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "红薯粉", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "芝麻", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "露蜂房", amount_min = 1, amount_max = 100, probability = 0.002},
			{type = "item", name = "黄泉灵液", amount_min = 1, amount_max = 100, probability = 0.002},
		}
	},
	autoplace = ap,
	pictures = pics,
