...
modtool.icons.setItemIcon("automation-science-pack",   "__xiuxian-graphics__/graphics/icons/danyao/dan-juqi.png", 128, 1)
modtool.icons.setItemIcon("utility-science-pack",   "__xiuxian-graphics__/graphics/icons/danyao/丹药瓶装01.png", 128, 1)
