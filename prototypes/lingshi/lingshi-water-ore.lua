...
data:extend({
    ...
    --},
    {
        ...
        minable = {
            hardness = 1,
            mining_particle = "shui-ling-shi-kuang-particle",
            mining_time = 1,
            --fluid_amount = 1,
            --required_fluid = (mods["Krastorio2"] and "mineral-water" or "water"),
            result = "shui-ling-shi-kuang"
        },
...
--local richness = data.raw.resource["shui-ling-shi-kuang"].autoplace.richness_expression
--data.raw.resource["shui-ling-shi-kuang"].autoplace.richness_expression = richness * noise.if_else_chain(
