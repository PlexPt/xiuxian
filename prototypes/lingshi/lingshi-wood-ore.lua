...
data:extend({
    ...
    },
    {
        ...
        stages = {
            sheet = {
                filename = "__xiuxian-graphics__/graphics/entity/ores/lingshi-wood-ore.png",
                priority = "extra-high",
                size = 64,
                frame_count = 8,
                variation_count = 8,
...
local richness = data.raw.resource["木灵石矿"].autoplace.richness_expression
data.raw.resource["木灵石矿"].autoplace.richness_expression = richness * noise.if_else_chain(
